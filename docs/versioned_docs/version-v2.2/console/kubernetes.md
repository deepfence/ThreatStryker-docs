...
2. **Install the ThreatStryker Console**
    ...
    ```bash
    # helm show values deepfence/deepfence-console --version 2.2.1 | less
...
3. To access ThreatStryker console install ```deepfence-router``` helm chart, this creates a `Loadbalancer` type service, the consle can be accessed over the loadbalancer created.
    ...
    ```bash
    # helm show values deepfence/deepfence-router --version 2.2.1
...
1. Save the helm chart values to file 
    ...
    ```bash
    helm show values deepfence/deepfence-console --version 2.2.1 > deepfence_console_values.yaml
    ```
...
1. Save the helm chart values to file
    ...
    ```bash
    helm show values deepfence/deepfence-router --version 2.2.1 > deepfence_router_values.yaml
    ```

...
:::note
Please note the agent image "quay.io/deepfenceio/deepfence_agent:2.2.1-fargate" is different from other deployment methods.
:::
...
Click on the _Add Container_ button to create a standard container for the ThreatStryker agent. Set image as _**quay.io/deepfenceio/deepfence_agent:2.2.1-fargate**_
...
```json
{
  ...
  "containerDefinitions": [
    ...
    },
    {
      ...
      "image": "quay.io/deepfenceio/deepfence_agent:2.2.1-fargate",

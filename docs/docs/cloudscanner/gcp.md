...
Cloud Scanner is deployed as a task within your Google Cloud Platform instance. The ThreatStryker console provides a simple terraform script to perform the deployment.
